...
## example:
## x <- matrix(data,nrow) # create matrix with some data and some # of rows
## xinv <- makeCacheMatrix(x) # cache the created matrix
...
## example:
## xinv$get()                 # return the matrix
## cacheSolve(xinv)           # return the inverse matrix
